...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		// Recuperando uma expressção, operação e resultado pelo ID
	...
	private static Nodo criarOperacao(String expressao) {
		...
		try {
			...
			// Não um valor numérico, trata-se de uma operação
			...
			if (indexOperador != -1) {
				// Separando a expressãoo nos operandos e operador
				...
				// Chamando recursivamente o método para criar as operaÃ§Ãµes dos operandos
				...
				throw new IllegalArgumentException("Expressção inválida.");
			}
		}
	}
}
